...
def parse_config(str):
    """Parse configuration string passed by the beancount "plugin" directive,
    e.g. plugin beancount_repete "repeat_limit=tomorrow".
    General expected string format is "key1=value1,key2=value2,..."
    """
    config = {
